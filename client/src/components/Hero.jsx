  ...
  return (
    <section className="h-screen flex items-center justify-center text-center relative overflow-hidden bg-[#000011]">
      ...
      <div className="relative z-10 px-4">
        ...
        >
          <a href="/images/Shivam resume.pdf"  className="px-6 py-3 rounded-full font-semibold text-white bg-gradient-to-r from-neon-blue to-neon-purple transition-transform duration-300 hover:scale-105 hover:shadow-glow-blue">
            Download Resume
          </a>
